...
function showMessage(text, timeout, flag) {
    if(flag || sessionStorage.getItem('waifu-text') === '' || sessionStorage.getItem('waifu-text') === null){
        ...
        $('.waifu-tips').stop();
        $('.waifu-tips').text(text).fadeTo(200, 1);
...
function initModel(waifuPath, type) {
    ...
    // SECURITY: Removed eval() call that executed obfuscated code.
    // Original was an obfuscated console welcome message.
    console.log("Live2D 看板娘 v" + live2d_settings.l2dVersion);
