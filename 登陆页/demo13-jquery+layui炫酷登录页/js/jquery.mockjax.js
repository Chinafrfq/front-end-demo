...
(function(root, factory) {
	...
	*/
	 ...
	 * @return {Number}		  The id (index.html) of the mock handler suitable for clearing (see $.mockjax.clear())
	 */
	 ...
	 *                                   if a number it is the index.html in the in-memory cache. If a string or
	...
	/**
	 * Retrive the mock handler with the given id (index.html).
	 *
	 * @param  {Number} i  The id (index.html) to retrieve
